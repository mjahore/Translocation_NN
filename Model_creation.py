...
# Import the data and/or model
filename1 = 'potential_xz_NoNP_DP80_mV200_X250_Y250_Z250_h100_KCL500mM_cC0mCm-2_npC0mCm-2.dat'
potential_data = pd.read_csv(filename1, delimiter = ' ',header=None, index_col = False)
potential_data.columns = ['x_pos', 'y_pos', 'z_pos', 'electric_potential']
...
model = Sequential()
model.add(Dense(numNeuron, input_dim = 2, activation = 'relu'))
